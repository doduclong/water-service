...
<header>
    <nav class="navbar navbar-expand-md navbar-dark bg-success">
        ...
        <ul class="navbar-nav">
            ...
            <li><a href="<%=request.getContextPath()%>/statistical" class="nav-link">Thống kê lượng nước</a></li>
            <li><a href="<%=request.getContextPath()%>/statisticalProfit" class="nav-link">Thống kê doanh thu</a></li>
